...
class TradeObject:
    def __init__(self, time_entry, time_exit, duration, pnl, winorloss, type, bbwp_entry, rsi, bmsb):
    ...
    def __str__(self):
        return "{}, {}, type: {}, duration: {}, pnl: {}, bbwp_entry: {}, rsi: {}".format(self.time_entry,
                                                                                         self.time_exit,
                                                                              self.type,
                                                               self.duration, self.pnl, self.bbwp_entry, self.rsi)
